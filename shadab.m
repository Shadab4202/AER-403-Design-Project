...
% X = [r1  r2  r3  r4  Cx  Cy ];
% r1: Crank (always the smallest)
% r2: Coupler
% r3: Lever 
% r4: Frame (r3+r4>=r1+r2)
...
elseif Check==4
    ...
    fprintf('The mechanism has two disconnected upper and lower regions\n');
    DIREC = 1;
...
Cx = Ax + Cu*cos(th2) - Cv*sin(th2);

Cy = Ay + Cu*sin(th2) + Cv*cos(th2);
